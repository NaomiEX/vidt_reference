...
class ConvertCocoPolysToMask(object):
    ...
    def __call__(self, image, target):
        ...
        ## transform into [x1, y1, x2, y2]
        boxes[:, 2:] += boxes[:, :2]
        # limit x1 and x2 to range [0, w]
        ...
        if self.return_masks: # NOTE: N/A
            segmentations = [obj["segmentation"] for obj in anno]
            masks = convert_coco_poly_to_mask(segmentations, h, w)

        keypoints = None
        if anno and "keypoints" in anno[0]: # NOTE: N/A
        ...
        return T.Compose([
            ...
            T.RandomSelect(
                ...
                T.Compose([
                    ...
                    T.RandomSizeCrop(384, 600), # smallest possible crop box is [384, 384] largest is [600, 600]
                    T.RandomResize(scales, max_size=scales[-1] * 1333 // 800),
                ])
            ),
            normalize,
